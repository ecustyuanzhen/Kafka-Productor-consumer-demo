...
public class NativeSimpleConsumer {
    ...
    public void run(long a_maxReads, String a_topic, int a_partition, List<String> a_seedBrokers, int a_port) throws Exception {
        ...
        while (a_maxReads > 0) {
            ...
            for (MessageAndOffset messageAndOffset : fetchResponse.messageSet(a_topic, a_partition)) {
                ...
                payload.get(bytes);
                String currentEvent = new String(bytes, "UTF-8");
                DBObject rawEvent = (DBObject) JSON.parse(currentEvent);
                //System.out.println(rawEvent.get("name"));
                System.out.println(String.valueOf(messageAndOffset.offset()) + ": " + currentEvent);
                send(rawEvent.get("name").toString());
                numRead++;
                a_maxReads--;
            }
    ...
    public void send(String to){
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/hello");
